...
export const pfizerData: CaseStudyData = {
  ...
  // LEGACY / SUMMARY FIELDS (for template footer)
  challenge: {
  ...
  results: {
    ...
    description:
      "65% faster MLR reviews, 3× throughput, $2.08M annual savings, and a scalable pattern for future AI platforms at Pfizer.",
  },
  testimonial: "",
