...
export default function PortfolioNavMenus({ variant = 'dark', onMegaMenuToggle, caseStudyData }: PortfolioNavMenusProps) {
  ...
  const brandRows = [
    ...
    { brand: 'IPG', slug: 'publicis', logo: '/assets/img/logo/IPG-white-logo.png', phases: ['Enterprise Systems Audit', 'Unified Content Supply Chain', 'Identity & Workflow Platform', 'Agency Team Training', '14 Agencies Unified'], product: 'Enterprise Content Platform', link: '/case-study/publicis', image: '/assets/img/home-06/project/publicishealth.jpg' },
