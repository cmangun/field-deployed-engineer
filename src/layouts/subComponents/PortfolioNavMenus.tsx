...
export default function PortfolioNavMenus({ variant = 'dark', onMegaMenuToggle, caseStudyData }: PortfolioNavMenusProps) {
  ...
  const brandRows = [
    { brand: 'Pfizer', slug: 'pfizer', logo: '/assets/img/case-studies/pfizer/pfizerlogo.png', phases: ['CEO Strike Force Discovery', 'AI Content Pipeline Design', 'RAG + SharePoint Build', 'Team Playbooks & Training', '200+ Users Enabled'], product: 'Enterprise AI Search Assistant', link: '/case-study/pfizer', image: '/assets/img/home-06/project/Embedded.jpg' },
    { brand: 'Colab', slug: 'colab', logo: '/assets/img/cmlogo.png', phases: ['Knowledge Landscape Discovery', 'RAG Knowledge Engine Design', 'Hybrid Search Pipeline', 'Champion Network & Adoption', '97% Search Time Reduction'], product: 'AI Knowledge Companion (CoCo)', link: '/case-study/colab', image: '/assets/img/home-06/project/colab.jpg' },
    { brand: 'Abbott', slug: 'abbott', logo: '/assets/img/case-studies/pfizer/pfizerlogo.png', phases: ['Diagnostic Workflow Mapping', '30K Device Architecture', 'BinaxNOW NLP Pipeline', 'HIPAA-Compliant Handoff', 'Global Diagnostics Scale'], product: 'ML-Ready Data Platform', link: '/case-study/abbott', image: '/assets/img/home-06/project/abbott.jpg' },
    { brand: 'IPG', slug: 'ipg', logo: '/assets/img/case-studies/pfizer/pfizerlogo.png', phases: ['Enterprise Knowledge Audit', 'Knowledge Graph Design', 'Intranet Platform Build', 'Self-Service Tooling', 'Agency Network Unified'], product: 'Global Knowledge Intranet', link: '/case-study/ipg', image: '/assets/img/home-06/project/publicishealth.jpg' },
    { brand: 'Syneos', slug: 'syneos', logo: '/assets/img/case-studies/pfizer/pfizerlogo.png', phases: ['Clinical Trial Process Mapping', 'Data Platform Architecture', 'Trial Analytics Engine', 'Ops Team Enablement', 'Trial Efficiency Gains'], product: 'Clinical Trial Analytics', link: '/case-study/syneos', image: '/assets/img/home-06/project/syneos.jpg' },
    { brand: 'Naked Heart', slug: 'nakedheart', logo: '/assets/img/case-studies/pfizer/pfizerlogo.png', phases: ['Foundation Needs Assessment', 'Donation Platform Design', 'Multi-Currency Build', 'Local Team Training', 'Russia/India/Frankfurt'], product: 'Global Donation Platform', link: '/case-study/nakedheart', image: '/assets/img/home-06/project/nakedheart.jpg' },
  ];
